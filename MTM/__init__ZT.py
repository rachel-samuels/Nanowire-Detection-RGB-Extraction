...
def drawBoxesOnRGB(image, tableHit, boxThickness=2, boxColor=(255, 0, 0), showLabel=False, labelColor=(255, 0, 0), labelScale=0.5 ):
    """
    ...
    def draw_rectangles_with_center(image, tableHit, boxColor=(0, 255, 0), boxThickness=2, showLabel=True, labelScale=1,
                                    labelColor=(0, 0, 255)):
        outImage = image.copy()
        ...
        for _, row in tableHit.iterrows():
            ...
            cv2.circle(outImage, (center_x, center_y), radius=5, color=(255, 0, 0), thickness=-1)
